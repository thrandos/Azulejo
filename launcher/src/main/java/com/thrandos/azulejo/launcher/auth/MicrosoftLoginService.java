...
import com.thrandos.azulejo.launcher.auth.microsoft.MicrosoftWebAuthorizer;
import com.thrandos.azulejo.launcher.auth.microsoft.MinecraftServicesAuthorizer;
import com.thrandos.azulejo.launcher.auth.microsoft.OauthResult;
import com.thrandos.azulejo.launcher.auth.microsoft.XboxTokenAuthorizer;
import com.thrandos.azulejo.launcher.auth.microsoft.model.McAuthResponse;
import com.thrandos.azulejo.launcher.auth.microsoft.model.McProfileResponse;
import com.thrandos.azulejo.launcher.auth.microsoft.model.TokenResponse;
import com.thrandos.azulejo.launcher.auth.microsoft.model.XboxAuthorization;
import com.thrandos.azulejo.launcher.auth.skin.MinecraftSkinService;
...
public class MicrosoftLoginService implements LoginService {
	...
	public static class Profile implements Session {
		...
		public String getSessionToken() {
			return "token:%s:%s".formatted(getAccessToken(), getUuid());
		}
