...
import com.thrandos.azulejo.launcher.creator.controller.task.DirectoryWalker;
import com.thrandos.azulejo.launcher.creator.dialog.VersionCheckDialog;
import com.thrandos.azulejo.launcher.creator.model.creator.ModFile;
import com.thrandos.azulejo.launcher.creator.model.swing.ModFileTableModel;
import com.thrandos.azulejo.launcher.creator.util.ModInfoReader;
import com.thrandos.azulejo.launcher.creator.util.ModInfoReader.ModInfo;
import com.thrandos.azulejo.launcher.creator.util.NemModList;
import com.thrandos.azulejo.launcher.creator.util.NemModList.ModEntry;
        ...
        Deferred<?> deferred = Deferreds.makeDeferred(executor.submit(walker), executor)
                ...
                .thenApply(files -> {
                    ...
                    for (File file : files) {
                        ...
                        if (!infoList.isEmpty()) {
                            ModInfo info = infoList.getFirst();
