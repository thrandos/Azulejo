...
import com.thrandos.azulejo.launcher.model.modpack.FileInstall;
 ...
 * {@link com.thrandos.azulejo.launcher.model.modpack.Manifest}.
 */
@Log
public class ClientFileCollector extends DirectoryWalker {
    ...
    protected void onFile(File file, String relPath) throws IOException {
        ...
        ClientFileCollector.log.info("Adding %s from %s...".formatted(relPath, file.getAbsolutePath()));
        if (copy) {
