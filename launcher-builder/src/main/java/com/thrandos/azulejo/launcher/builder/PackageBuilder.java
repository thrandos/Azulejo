...
import com.thrandos.azulejo.launcher.builder.loaders.*;
import com.thrandos.azulejo.launcher.model.loader.BasicInstallProfile;
import com.thrandos.azulejo.launcher.model.minecraft.Library;
import com.thrandos.azulejo.launcher.model.minecraft.ReleaseList;
import com.thrandos.azulejo.launcher.model.minecraft.Version;
...
public class PackageBuilder {
    ...
    public PackageBuilder(@NonNull ObjectMapper mapper, @NonNull Manifest manifest) throws IOException {
        this.properties = LauncherUtils.loadProperties(Launcher.class,
                "launcher.properties", "com.thrandos.azulejo.launcher.propertiesFile");
